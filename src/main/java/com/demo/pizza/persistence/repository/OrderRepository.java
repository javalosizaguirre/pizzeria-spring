...
public interface OrderRepository extends ListCrudRepository<OrderEntity, Integer> {
    ...
    List<OrderEntity> findCustomerOrders(String idCustomer);


    @Query(value = "SELECT po.id_order AS idOrder, cu.name AS customerName, po.date AS orderDate, po.total AS orderTotal, " +
